...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    fileprivate func setupPageController() {
        ...
        self.slidingView.addSubview(self.pageViewController!.view)
        
        // Set the page view controller's bounds using an inset rect so that self's view is visible around the edges of the pages.
        var pageViewRect = self.slidingView.bounds
    ...
    @IBAction func pageChanged(_ sender: UIPageControl) {
        ...
        let startingViewController: CityViewController = self.modelController.viewControllerAtIndex(sender.currentPage, storyboard: self.storyboard!)!
        let viewControllers = [startingViewController]
        self.pageViewController!.setViewControllers(viewControllers, direction: .forward, animated: false, completion: {done in })
...
/*
    func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewControllerSpineLocation {
        ...
        let currentViewController = self.pageViewController!.viewControllers![0] as! CityViewController
